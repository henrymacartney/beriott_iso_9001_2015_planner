...
let predefinedTasks = [
    // Phase 1: LEARN
    { id: 1, phaseId: 1, name: "Acquire BS EN ISO 9001:2015 and associated documents", docRef: "BS EN ISO 9001:2015", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 2, phaseId: 1, name: "Top Management Commitment", docRef: "Quality Management Principles (ISO 9000:2005)", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 3, phaseId: 1, name: "Choose a Registrar & Define Scope of Certification", docRef: "DQS Frankfurt / TÜV Wiesbaden", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 4, phaseId: 1, name: "Conduct a Gap Analysis", docRef: "Gap Analysis", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 5, phaseId: 1, name: "Management Review", docRef: "Review of Completion", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },

    // Phase 2: PLAN
    { id: 6, phaseId: 2, name: "Establish an Implementation Team", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 7, phaseId: 2, name: "Develop the Implementation Plan (this document)", docRef: "ISO 9001 Implementation Plan (this document)", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 8, phaseId: 2, name: "Identify Key Processes", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 9, phaseId: 2, name: "Involve & Communicate with Employees", docRef: "Exployee Awareness Presentation", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 10, phaseId: 2, name: "Management Review", docRef: "Review of Completion", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },

    // Phase 3: DEFINE
    { id: 11, phaseId: 3, name: "Define the Quality Policy", docRef: "Quality Policy Revision 1", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 12, phaseId: 3, name: "Communicate the Quality Policy", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 13, phaseId: 3, name: "Define the Quality Objectives", docRef: "Quality Manual Revision 1", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 14, phaseId: 3, name: "Establish Roles & Responsibilities", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 15, phaseId: 3, name: "Management Review", docRef: "Review of Completion", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },

    // Phase 4: BUILD
    { id: 16, phaseId: 4, name: "Develop the Quality Manual", docRef: "Quality Manual - Final Revision", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 17, phaseId: 4, name: "Develop the Mandatory Standard Operating Procedures", docRef: "Mandatory Procedures Templates", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 18, phaseId: 4, name: "Develop the Operational Procedures (Work Instructions)", docRef: "Operational Procedures Templates", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 19, phaseId: 4, name: "Select and Train Internal Auditors", docRef: "Internal Auditor Training", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 20, phaseId: 4, name: "Execute Initial Internal Audit", docRef: "Review of Completion", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 21, phaseId: 4, name: "Develop Audit Reporting System", docRef: "Internal Audit Awareness", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 22, phaseId: 4, name: "Define Responsibilities", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 23, phaseId: 4, name: "Integration into QMS / SOPs / WIs", docRef: "Internal Audit Checklist for Company", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 24, phaseId: 4, name: "Management Review", docRef: "Review of Completion", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },

    // Phase 5: LAUNCH
    { id: 25, phaseId: 5, name: "Provide Employee Training on all aspects of the QMS", docRef: "Key Process Audit Checklists", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 26, phaseId: 5, name: "Implement the Quality Management System", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 27, phaseId: 5, name: "Formal Internal Audit the Quality System", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 28, phaseId: 5, name: "Management Review", docRef: "Review of Completion", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },

    // Phase 6: REVIEW
    { id: 29, phaseId: 6, name: "Begin Process Auditing", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 30, phaseId: 6, name: "Implement System Changes", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 31, phaseId: 6, name: "Refine the System", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 32, phaseId: 6, name: "Management Review", docRef: "Review of Completion", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },

    // Phase 7: ASSESSMENT
    { id: 33, phaseId: 7, name: "Certification Body Preliminaries", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 34, phaseId: 7, name: "Pre-assessment Audit", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 35, phaseId: 7, name: "Correct Non-conformances & Corrective Action", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 36, phaseId: 7, name: "Final Management Review", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 37, phaseId: 7, name: "Certification Day", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 38, phaseId: 7, name: "Surveillance Audits", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" },
    { id: 39, phaseId: 7, name: "Maintain and Improve the QMS", docRef: "", startDate: "", targetDate: "", complete: 0, status: "Not Started", actionWho: "" }
];
